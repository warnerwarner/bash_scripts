...
#SBATCH --array=0-6    ## N_TASKS_TOTAL: SET THIS TO THE NUMBER OF INDEPENDENT JOBS,TYPICLLAY 100,SEE BELOW N_TASKS_TOTAL
...
python PCA_increasing_units.py $SLURM_ARRAY_TASK_ID
